...
def time_shortestpath(nx_links, flow_catalogue, nx_flows, out_file):
	...
	set_weights_on_available_capa_SP(nx_links)
	...
	if total_size <= 0.0:
		...
		# Assignment Phase
		Tglob = 0                 #calculate_t_s(total_size, nx_links)  DA SISTEMARE!!! DIVISIONE PER ZERO
